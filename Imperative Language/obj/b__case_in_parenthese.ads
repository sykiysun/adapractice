...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_case_in_parenthese" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#eadd1e38#;
   pragma Export (C, u00001, "case_in_parentheseB");
