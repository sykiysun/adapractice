...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_declarative_regions" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#87740eaf#;
   pragma Export (C, u00001, "declarative_regionsB");
