...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_greet_i_times_while" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5f58130c#;
   pragma Export (C, u00001, "greet_i_times_whileB");
