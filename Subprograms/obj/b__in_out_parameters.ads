...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_in_out_parameters" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f3d6410f#;
   pragma Export (C, u00001, "in_out_parametersB");
   ...
   u00121 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00121, "system__concat_4B");
   u00122 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00122, "system__concat_4S");
   u00123 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00123, "system__concat_3B");
   u00124 : constant Version_32 := 16#248a0db1#;
